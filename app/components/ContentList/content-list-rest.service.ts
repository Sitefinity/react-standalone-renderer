import {ContentContext, ContentVariation} from '@/app/cms/editor/designer-entities/mixed-content-context';
import {CombinedFilter} from '@/app/cms/sdk/filters/combined-filter';
import {FilterClause, FilterOperators} from '@/app/cms/sdk/filters/filter-clause';
import {OrderBy} from '@/app/cms/sdk/filters/orderby';
...
import {DateOffsetPeriod} from '@/app/components/ContentList/date-offset-period';
...
export class ContentListRestService {
    static getItems(entity: ContentListEntity, detailItem: DetailItem | null): Promise<CollectionResponse<SdkItem>> {
        if (entity.SelectedItems && entity.SelectedItems.Content && entity.SelectedItems.Content.length > 0) {
            ...
            const filters: Array<CombinedFilter | FilterClause | RelationFilter | null> = [
                mainFilter,
                additionalFilter,
                parentFilter,
            ];
    ...
    private static getMainFilter(
        entity: ContentListEntity,
        variation: ContentVariation,
    ): CombinedFilter | FilterClause | RelationFilter | null {
    ...
    private static getParentFilterExpression(
        selectedContent: ContentContext,
        variation: ContentVariation,
    ...
    private static getSkipAndTake(
        entity: ContentListEntity,
        pageNumber: number,
    ): {Skip?: number; Take?: number; Count?: boolean; ShowPager?: boolean} {
    ...
    private static getOrderByExpression(entity: ContentListEntity): OrderBy | null {
        ...
        const sortExpression = entity.OrderBy == 'Custom' ? entity.SortExpression : entity.OrderBy;
