...
export function ContentBlock(props: ModelBase<ContentBlockEntity>) {
    ...
    useEffect(() => {
        ...
        if (props.Properties.WrapperCssClass) dataAttributes['class'] = props.Properties.WrapperCssClass;
    ...
    return <div {...(data.attributes as any)} dangerouslySetInnerHTML={createMarkup(data.content)} />;
}
